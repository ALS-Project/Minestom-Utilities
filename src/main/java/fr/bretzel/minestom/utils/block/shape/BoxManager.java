...
import fr.bretzel.minestom.utils.block.shape.bounding.*;
import fr.bretzel.minestom.utils.block.shape.box.*;
import fr.bretzel.minestom.utils.block.shape.outline.*;
import fr.bretzel.minestom.utils.block.shape.shapes.Shape;
import fr.bretzel.minestom.utils.block.shape.visual.*;
